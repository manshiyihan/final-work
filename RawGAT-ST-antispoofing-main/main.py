...
if __name__ == '__main__':
    ...
    parser.add_argument('--protocols_path', type=str, default='/home/xujiwu/下载/RawGAT-ST-antispoofing-main/database', help='Change with path to user\'s LA database protocols directory address')
    '''
    % protocols_path/
    ...
    parser.add_argument('--model_path', type=str,
                        default=str(BASE_DIR / "epoch_42.pth"), help='Model checkpoint')
